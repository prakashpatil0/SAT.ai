  ...
  return (
    <View style={styles.container}>
      <TouchableOpacity
        ...
        onPress={() => navigation.navigate("HrHomeScreen" as never)}
      >
        <MaterialIcons
          name="home"
          size={24}
          color={isRouteActive("HrHomeScreen") ? "#FF8447" : "#666"}
        />
        <Text
          style={[
            styles.tabText,
            isRouteActive("HrHomeScreen") && styles.activeTabText,
          ]}
        >
          Home
        </Text>
