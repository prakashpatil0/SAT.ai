...
type AccountantMainLayoutProps = {
...
const AccountantMainLayout: React.FC<AccountantMainLayoutProps> = ({
  children,
  title,
  showBackButton = true,
  showDrawer = true,
    ...
    <View style={styles.container}>
      <View style={styles.headerContainer}>
        ...
        <View style={styles.topRow}>
          ...
          <TouchableOpacity 
            onPress={() => navigation.navigate('FinanceAccountantProfile' as never)}
...
export default AccountantMainLayout; 