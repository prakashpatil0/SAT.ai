...
const AuthorityMainLayout: React.FC<AuthorityMainLayoutProps> = ({
  children,
  title,
  showBackButton = true,
  showDrawer = true,
    ...
    <View style={styles.container}>
      <View style={styles.headerContainer}>
        ...
        <View style={styles.topRow}>
          ...
          <TouchableOpacity 
            onPress={() => navigation.navigate('AuthorityProfile' as never)}
...
export default AuthorityMainLayout; 