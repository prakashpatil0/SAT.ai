...
import { AccountantStackParamList } from "@/app/index";
import { useProfile } from "@/app/context/ProfileContext";
import { LinearGradient } from "expo-linear-gradient";
import { storage } from "@/firebaseConfig";
import { ref, getDownloadURL } from "firebase/storage";
const AccountantDrawer = (props: DrawerContentComponentProps) => {
  ...
  const handleNavigate = (screenName: keyof AccountantStackParamList) => {
    ...
    <View style={styles.container}>
      ...
      >
        ...
        <TouchableOpacity
          ...
          onPress={() => handleNavigate("FinanceAccountantProfile")}
        >
          {isImageLoading ? (
            <ActivityIndicator
              size="small"
...
export default AccountantDrawer;
