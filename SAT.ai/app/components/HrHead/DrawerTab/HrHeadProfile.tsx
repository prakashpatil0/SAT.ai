...
import HrHeadMainLayout from "@/app/components/HrHeadMainLayout";
...
const HrHeadProfile = () => {
        ...
        if (data.profileImageUrl) {
          ...
          try {
            ...
            if (response.ok) {
              ...
              console.error(
                "Profile image URL not accessible:",
                response.status
              );
              ...
              try {
                ...
                console.log(
                  "Successfully loaded default profile image URL:",
                  url
                );
  ...
  if (isLoading) {
    return (
      <AppGradient>
        <HrHeadMainLayout title="Profile" showBackButton showDrawer={true}>
          <ProfileSkeleton />
        </HrHeadMainLayout>
      </AppGradient>
    );
