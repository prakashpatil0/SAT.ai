...
import { SoftwareDevStackParamList } from "@/app/index";
import { useProfile } from "@/app/context/ProfileContext";
import { LinearGradient } from "expo-linear-gradient";
import { storage } from "@/firebaseConfig";
import { ref, getDownloadURL } from "firebase/storage";
const SoftwareDevDrawer = (props: DrawerContentComponentProps) => {
  ...
  const handleNavigate = (screenName: keyof SoftwareDevStackParamList) => {
    ...
    <View style={styles.container}>
      ...
      >
        ...
        <TouchableOpacity
          ...
          onPress={() => handleNavigate("ItProfile")}
        >
          {isImageLoading ? (
            <ActivityIndicator
              size="small"
...
export default SoftwareDevDrawer;
