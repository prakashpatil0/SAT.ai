...
import LineManagerMainLayout from "@/app/components/LineManagerMainLayout";
...
const LineManagerProfile = () => {
  ...
  if (isLoading) {
    return (
      <AppGradient>
        <LineManagerMainLayout title="Profile" showBackButton showDrawer={true}>
          <ProfileSkeleton />
        </LineManagerMainLayout>
      </AppGradient>
    );
  }
