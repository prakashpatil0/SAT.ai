...
import MarketingMainLayout from "@/app/components/MarketingMainLayout";
...
const DigitalMarketingProfile = () => {
    ...
    try {
      ...
      if (userDoc.exists()) {
        ...
        setFormData({
          ...
          designation: data.designation || "", // ✅ Add this
        });
  ...
  const handleSaveChanges = async () => {
    try {
      ...
      const updateData = {
        name: formData.name,
        designation: formData.designation, // ✅ Use dynamic value
  ...
  if (isLoading) {
    return (
      <AppGradient>
        <MarketingMainLayout title="Profile" showBackButton showDrawer={true}>
          <ProfileSkeleton />
        </MarketingMainLayout>
      </AppGradient>
    );
                  ...
                  <>
                    ...
                    <View style={styles.infoRow}>
                      ...
                      <View style={styles.infoContent}>
                        ...
                        <Text style={styles.infoValue}>{formData.designation}</Text>
                      </View>
                    </View>
...
export default DigitalMarketingProfile;
